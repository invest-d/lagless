...
export const get_pay_term_start_date = (target_date) => {
...
export const get_pay_term_end_date = (target_date) => {
    // target_dateが属する申込可能な稼働期間の終了日を取得する
...
export const get_next_business_date = (target_date) => {
