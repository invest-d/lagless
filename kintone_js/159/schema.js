        ...
        "layout": [
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><b><font size=\"4\">■申込者の属性情報&#xff08;申込フォーム入力項目&#xff09;</font>--------------------------------------------------------------------------------------------------------------------------</b><br /></div>",
                        "size": {}
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><b><font size=\"4\">■発注企業情報</font>-------------------------------------------------------------------------------------------------------------------------------------------------------------------</b><br /></div>",
                        "size": {}
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><font color=\"#cc0000\"><b>金額・日付の修正は手動で行わないでください。</b></font><div><font color=\"#cc0000\"><b>それらを修正する必要がある場合、まずは本文をCtrl&#43;Aで全て選択して削除します。</b></font></div><div><b><font color=\"#cc0000\">その後、フォーム上部の金額・日付</font><span style=\"color:rgb( 204 , 0 , 0 )\">フィールドの値を修正してレコードを保存してから、支払予定明細書を再作成してください。</span></b></div></div>",
                        "size": {}
                    }
                ]
            },
