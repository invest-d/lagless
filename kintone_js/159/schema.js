        ...
        "layout": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {
                        "type": "LABEL",
                        "label": "<div>【入力事項】<br /></div><div>・登記取得の要否<br /></div><div>・会費等の差引額&#xff08;工務店マスタ→営業案件&#xff09;<br /></div><div>・支払日&#xff08;工務店マスタ&#xff09;<br /></div><div><div>・協力会社ID　※回数制限を確認</div><div>・協力会社マスタに取引企業管理No.を登録<br /></div><div><br /></div></div><div>※振込金額確認後「状態&#xff1a;ID確認済」に変更し、</div><div>「支払明細書一括作成」ボタンを押すと、自動でメール送信される。</div>",
                        "size": {}
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><span style=\"font-weight:700\"><font size=\"4\">■申込者の属性情報&#xff08;申込フォーム入力項目&#xff09;</font></span>--------------------------------------------------------------------------------------------------------------------------<br /></div>",
                        "size": {}
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><span style=\"font-weight:700\"><font size=\"4\">■発注企業情報</font></span>-------------------------------------------------------------------------------------------------------------------------------------------------------------------<br /></div>",
                        "size": {}
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    {
                        "type": "LABEL",
                        "label": "<div><span style=\"font-weight:700\"><font color=\"#cc0000\">金額・日付の修正は手動で行わないでください。</font></span><div><font color=\"#cc0000\"><span style=\"font-weight:700\">それらを修正する必要がある場合、まずは本文をCtrl&#43;Aで全て選択して削除します。</span></font></div><div><font color=\"#cc0000\"><span style=\"font-weight:700\">その後、フォーム上部の金額・日付</span></font><span style=\"font-weight:700;color:rgb( 204 , 0 , 0 )\">フィールドの値を修正してレコードを保存してから、支払予定明細書を再作成してください。</span></div></div>",
                        "size": {}
                    }
                ]
            },
